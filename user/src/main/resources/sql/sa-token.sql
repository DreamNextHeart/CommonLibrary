...
CREATE TABLE `menu`  (
  ...
  `compoent` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
...
-- Records of menu
-- ----------------------------
INSERT INTO `menu` VALUES (1, '组织架构', 0, 'sys/organization/index', 'sys:organization:index');
INSERT INTO `menu` VALUES (2, '权限管控', 0, 'sys/permission/index', 'sys:permission:index');
INSERT INTO `menu` VALUES (3, '业务模块', 0, 'sys/business/index', 'sys:business:index');
INSERT INTO `menu` VALUES (101, '组织管理', 1, 'sys/organization/list', 'sys:organization:list');
INSERT INTO `menu` VALUES (102, '用户管理', 1, 'sys/user/list', 'sys:user:list');
INSERT INTO `menu` VALUES (103, '职位管理', 1, 'sys/post/list', 'sys:post:list');
INSERT INTO `menu` VALUES (201, '角色管理', 2, 'sys/role/list', 'sys:role:list');
INSERT INTO `menu` VALUES (202, '模块管理', 2, 'sys/module/list', 'sys:module:list');
INSERT INTO `menu` VALUES (203, '菜单管理', 2, 'sys/menu/list', 'sys:menu:list');
INSERT INTO `menu` VALUES (301, '食物业务', 3, 'sys/food/list', 'sys:food:list');
INSERT INTO `menu` VALUES (302, '饮料业务', 3, 'sys/beverage/list', 'sys:beverage:list');
INSERT INTO `menu` VALUES (303, '娱乐业务', 3, 'sys/recreation/list', 'sys:recreation:list');
INSERT INTO `menu` VALUES (1001, '组织审核', 101, 'organization/check/perms', 'organization:check:perms');
INSERT INTO `menu` VALUES (1002, '用户审核', 102, 'user/check/perms', 'user:check:perms');
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (1, '三岁', '15767686503', 'yjsansui@163.com', '7k00qpevf1icpffc257ubas8kg', 'w7aPT', '571b2f08-e070-493e-861b-661fdeb24418', '1');
INSERT INTO `user` VALUES (2, '叫阿三的', '15767686505', 'yjsansui@163.com', '3gvjic0urea6cla69v9cp3qgd', 'QbAkx', '571b2f08-e070-493e-861b-661fdeb24419', '1');
INSERT INTO `user` VALUES (3, '四岁', '15767686501', 'yjsansui@163.com', '3gvjic0urea6cla69v9cp3qgd', 'QbAkx', '1', '0');
INSERT INTO `user` VALUES (24, 'String', 'String', 'String', '4e9197vpv9r5v4ot77o6scic0q', 'nc3XE', 'String', '\0');
